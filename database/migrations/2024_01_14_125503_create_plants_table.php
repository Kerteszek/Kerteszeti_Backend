...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('plants')->insert([
            ...
            ['scientific_name' => 'Rosa hybrid', 'name' => 'Vörös rózsa', 'plant_category' => 106], //vörös
            ...
            ['scientific_name' => 'Cucurbita pepo Goldena', 'name' => 'Sárga Cukkini', 'plant_category' => 104], //sárga
            ['scientific_name' => 'Cucurbita pepo', 'name' => 'Zöld Cukkini', 'plant_category' => 104], //ződ
            ['scientific_name' => 'Cucurbita pepo Lajkonik', 'name' => 'Csíkos Cukkini', 'plant_category' => 104], //csíkos
        ]);
